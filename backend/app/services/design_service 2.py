...
def _regenerate_geometry(db: Session, design: Design, spec: DesignSpec) -> None:
    ...
    design.semantic_json = {
        ...
        # Phase 5/6: semantic selectable-geometry metadata for Fusion-style editing.
        "selectable_faces": result.selectable_faces,
        "selectable_edges": result.selectable_edges,
        "selectable_holes": result.selectable_holes,
...
class CriticalEditRejected(Exception):
    """An edit produced a critically-failed design; the original was preserved."""
